        ...
        <div class=" container ">
            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-separate table-head-custom" id="donation_datatable">
                    <thead>
                        <tr>
                            <th width="10%">Kode</th>
                            <th>Nama</th>
...
<!--end::Page Scripts-->
<script>
    let donationPage = function () {
        let donationTable = function () {
            let table = $('#donation_datatable').DataTable({
                responsive: true,
                processing: true,
                serverSide: true,
                language: {
                ...
                ajax: {
                    'url': '{{ route('dashboard.master.object.data') }}',
                    'type': 'GET'
                },
                columns: [
                    {data: 'code', name: 'code'},
